...
class  CompanyState extends State <Company> {
            ...
            child: 
                ...
                Row(
                  ...
                  children:[
                    ...
                    Text("Companies",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
  ...
  Widget companieslist(BuildContext context){
    return Expanded(
      child: _users.length == 0 ? CircularProgressIndicator(color: white) : _users.length == 0 ? CircularProgressIndicator(color: white) : ListView.builder(itemBuilder: (context, i){
      var _user = _users[i];
        return Container(
